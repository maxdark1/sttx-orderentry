...
@Component({
  selector: 'app-gridpartes-discreta',
  templateUrl: './gridpartes-discreta.component.html',
  styleUrls: ['./gridpartes-discreta.component.css'],
  encapsulation: ViewEncapsulation.None,
  providers: [OrdenService, EstadisticaService, configuracionService]
})
export class GridpartesDiscretaComponent implements OnInit {
  //Inputs
  ...
  public cellCloseHandler(args: any) {
    if (this.aprobada != true) {
      ...
      let año = parseInt(this.fechaFin.getFullYear().toString());
      let mes = this.fechaFin.getMonth();
      let dia = this.fechaFin.getDate() + this.dias;
      let fechaFinal: Date = new Date(año,mes,dia);
